...
from ..params import main_params, amenities
...
async def get_hotels(prompt: str = Query(None, description="Filter hotels by name or location")):
    if not prompt:
    ...
    return HotelResponse(hotels=transform_hotels(matching_hotels), user_preferences=user_preferences) 